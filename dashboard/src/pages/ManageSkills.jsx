            ...
            <CardContent className='grid sm:grid-cols-2 gap-4'>
              {
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <Trash2  onClick={() => handleDeleteSkill(element._id)}  className="h-5 w-5 hover:text-red-500" />
                              </TooltipTrigger>
                ...
                ) : (<CardTitle className='text-3xl overflow-hidden'>You have Not Added Any Skills</CardTitle>)
              }
            </CardContent>
          </Card>
        </TabsContent>
