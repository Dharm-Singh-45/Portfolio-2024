  ...
  return (
    <>
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
        <main className="flex flex-wrap justify-center items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:w-full xl:w-full w-screen" >
          <div className='"grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2"'>
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4">
              <Card className="sm:col col-span-2">
            ...
            <div>
                  ...
                  <Card>
                    ...
                    <CardContent className="grid sm:grid-cols-2 gap-4">
                      {skills && skills.length > 0 ? (
                        ...
                        <p className="text-3-xl overflow-y-hidden">
              ...
              <Tabs>
                <TabsContent className="grid min-[1050px]:grid-color-2 gap-4">
                  <Card>
                    <CardHeader className="px-7">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <Table>
                        ...
                        <TableBody>{timeline && timeline.length > 0 ? (
                          ...
                          <TableRow>
                            <TableCell className='text-3xl overflow-hidden'>Yoy have not added any Timeline </TableCell>
                          </TableRow>
                        ) }</TableBody>
                      </Table>
                    </CardContent>
