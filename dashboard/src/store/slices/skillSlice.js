...
export const getAllSkills = () => async(dispatch) =>{
    ...
    try {
        const {data} = await axios.get('https://portfolio-backend-nlxk.onrender.com/api/v1/skill/getall',{withCredentials:true})
...
export const addNewSkill = (data) =>async(dispatch) =>{
    ...
    try {
        const response = await axios.post('https://portfolio-backend-nlxk.onrender.com/api/v1/skill/add',data,{withCredentials:true,headers:{"Content-Type":"multipart/form-data"}})
...
export const updateSkill = (id, proficiency) => async (dispatch) => {
    ...
    try {
      const response = await axios.put(
        `https://portfolio-backend-nlxk.onrender.com/api/v1/skill/update/${id}`,
        { proficiency },
        {
...
export const deleteSkill = (id) => async (dispatch) => {
    ...
    try {
      const response = await axios.delete(
        `https://portfolio-backend-nlxk.onrender.com/api/v1/skill/delete/${id}`,
        {
          withCredentials: true,
        }
      );
