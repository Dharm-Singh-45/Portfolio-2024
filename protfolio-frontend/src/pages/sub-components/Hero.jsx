...
import { ExternalLink, Github, Instagram, Linkedin, Twitter, Youtube } from "lucide-react";
  ...
  return (
    <div className="w-full">
      ...
      <h1 className="text-tubeLight-effect overflow-x-hidden text-[1.3rem] sm:text-[1.7rem] md:text[2.2rem] lg:text-[2.8rem] tracking-[15px]">
        <Typewriter
          words={["FullSTACK DEVELOPER", "TRADER", "FREELANCER"]}
          loop={100}
         cursor
          typeSpeed={70}
          deleteSpeed={70}
      ...
      <div className="mt4 md:m-5-8 lg:mt-10 flex gap-3">
